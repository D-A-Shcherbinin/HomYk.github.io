    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-3">
                <div class="reg-wrap">
                    <div class="reg-title">Регистрационая формочка</div>
                    <form action="" method="post" class="reg-form">
                        <p><label for="name">Имечко</label>
                            <?php print $ename; ?>
                        </p>
                        ...
                        <p><label for="conatct">Контактик</label>
                            <?php print $econtact; ?>
                        </p>
                        <p><input type="text" name="contact" value="<?php print $contact; ?>"></p>

                        <p><label for="password">Парольчик</label>
                            <?php print $epassword; ?>
                        </p>
                        <p><input type="password" name="password" value=""></p>
                        
                        <p><label for="cpassword">Подтверждение парольчика</label>
                        ...
                        <div>У вас есть акк?<a href="?p=login">Добро пожаловать!</a></div>
                    </form>
