...
<div class="row">
    <div class="col-md-7">
        <form action="" method="post" enctype="multipart/form-data">
            <p><label for="page">Страница</label><?php print $epage; ?></p>
            <select name="page">
            ...
            <p><label for="title">Заголовок</label><?php print $etitle; ?></p>
            <p><input type="text" name="title" value="<?php print $title; ?>"></p>

            <p><label for="image">Изображение</label><?php print $eimage; ?></p>
